...
class CQT(_CQT):
    ...
    def __init__(self, n_octaves, bins_per_octave, sample_rate, secs_per_block, fmin, n_bins):
        """
    ...
    @staticmethod
    def to_spectral_flux(magnitude):
        """
        ...
        for s in range(1, magnitude.size(-1)):
            prevSpectrum = magnitude[..., s - 1]
            spectrum = magnitude[..., s]

            spectralFlux[..., s] = spectrum - prevSpectrum
